                        ...
                        <form onSubmit={handleLogin} className="space-y-6">
                            ...
                            <div className="pt-3 w-full text-center">
                                                <Link
                                                    ...
                                                    <span>Don't have an account? <span className="text-indigo-600">SignUp</span></span>
                                                </Link>
                                                <Link
                                                    href="/employee/login"
                                                    className="inline-flex items-center space-x-2 text-gray-700 hover:text-indigo-600 transition-all duration-200"
                                                >
                                                    <span>Are You an Employee?<span className="text-indigo-600">Let's LogIn</span></span>
                                                </Link>
                            </div>
                        </form>
                    </div>
